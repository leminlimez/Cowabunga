...
public struct Whitelist {
    ...
    public static func overwriteBlacklist() -> Bool {
        return MDC.overwriteFile(at: "/private/var/db/MobileIdentityData/Rejections.plist", with: try! Data(base64Encoded: blankplist)!)
    }
    
    public static func overwriteBannedApps() -> Bool {
        return MDC.overwriteFile(at: "/private/var/db/MobileIdentityData/AuthListBannedUpps.plist", with: try! Data(base64Encoded: blankplist)!)
    }
    
    public static func overwriteCdHashes() -> Bool {
        return MDC.overwriteFile(at: "/private/var/db/MobileIdentityData/AuthListBannedCdHashes.plist", with: try! Data(base64Encoded: blankplist)!)
    }
